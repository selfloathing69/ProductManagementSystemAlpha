...
{
    /// <summary>
    /// SOLID - I: Реализует интерфейс IDomainObject для обеспечения полиморфизма доменных объектов (работаем с
    /// разными типами доменных сущностей через общий интерфейс).
